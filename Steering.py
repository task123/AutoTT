...
class SteeringWithIOSGyro:
    def __init__(self, motors, autoTTCommunication = None, gyro_update_intervall = 1.0/60.0, min_roll = 2.0 * 3.14 / 180.0, max_roll = 45.0 * 3.14 / 180.0, max_pitch = 80.0 * 3.14 / 180.0):
        self.motors = motors
        self.stop = True
